...
.config(function ($translateProvider) {
  $translateProvider.translations('ru', {
    ...
    AUTUMN: 'Осень',
    WINTER: 'Зима',
    SPRING_SUBTITLE: 'с 20 апреля по 15 июня',
    SUMMER_SUBTITLE: 'с 15 июня по 10 августа',
    AUTUMN_SUBTITLE: 'с 10 августа по 25 октября',
    WINTER_SUBTITLE: 'с 1 января по 15 апреля',
    ABOUT_US: 'О нас',
    ABOUT_LEAGUE: 'О лиге',
    ABOUT_BAIKAL: 'О Байкале',
    FAMILY: 'Семья',
    NEWS: 'Новости',
    MEDIA: 'СМИ',
  ...
  $translateProvider.translations('en', {
    ...
    AUTUMN: 'Autumn',
    WINTER: 'Winter',
    SPRING_SUBTITLE: 'from 20th of april to 15th of june',
    SUMMER_SUBTITLE: 'from 15th of june to 10th of august',
    AUTUMN_SUBTITLE: 'from 10th of august to 25th of october',
    WINTER_SUBTITLE: 'from 1st of january to 15th of aprile',
    ABOUT_US: 'About us',
    ABOUT_LEAGUE: 'About League',
    ABOUT_BAIKAL: 'About Baikal',
    FAMILY: 'Family',
    NEWS: 'News',
    MEDIA: 'Media',
    ...
    SKYPE_LESSONS_TEXT: 'KC has studied and lived in the USA, France, Spain and China. She has been to more than 10 different countries, and has been teaching English for 6 years. KC is fluent in English fluently and continues to travel and explorу the world. If you are looking to learn Russian and have an online pen-pal, KC offers Skype lessons from every corner of Earth.',
