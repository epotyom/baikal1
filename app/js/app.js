...
.config(function ($translateProvider) {
  $translateProvider.translations('ru', {
    ...
    CONTACTS: 'Контакты',
    FILMS: 'Фильмы',
    SPRING_BAIKAL_FILM: 'Байкал весной',
    SUMMER_BAIKAL_FILM: 'Байкал летом',
    AUTUMN_BAIKAL_FILM: 'Осенний байкал',
    WINTER_BAIKAL_FILM: 'Байкал зимой',
  ...
  $translateProvider.translations('en', {
    ...
    CONTACTS: 'Contacts',
    FILMS: 'Films',
    SPRING_BAIKAL_FILM: 'Spring Baikal',
    SUMMER_BAIKAL_FILM: 'Summer Baikal',
    AUTUMN_BAIKAL_FILM: 'Autumn Baikal',
    WINTER_BAIKAL_FILM: 'Winter Baikal',
